            ...
            <div class="col-md-9">
                ...
                <div class="widget">
					<div class="widget-header clearfix">
						<h3><i class="icon ion-compose"></i> <span>할인 이벤트 등록</span></h3>
					...
					<div class="widget-content">
						<form class="form-horizontal form-ticket" role="form", action="/add_dc_event" method="post" >
							<fieldset>
								<legend>등록 양식</legend>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="dc_rate" name="dc_rate" placeholder="할인율">
									</div>
								</div>
								<div class="form-group">
