            ...
            <div class="col-md-9">
                ...
                <div class="widget">
					<div class="widget-header clearfix">
						<h3><i class="icon ion-compose"></i> <span>증정 이벤트 수정</span></h3>
					...
					<div class="widget-content">
						<form class="form-horizontal form-ticket" role="form", action="/alter_pr_event" method="post" >
							<fieldset>
								<input type="hidden" name="present_no" value=${event.present_no}>
								<legend>등록 양식</legend>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" id="present_prod" name="present_prod" placeholder="이벤트 상품" value=${event.present_prod}>
									</div>
								</div>
								<div class="form-group">
