        ...
        <div class="widget">
            <h3 class="widget-header clearfix">
                <h3>
                    ...
                    <span>직원 정보</span>
                    <button type = "button" onclick="location.href= '/alter_employee'" class = "btn btn-default btn-lg" id="selectBtn">정보수정</button>
                    <button type = "button" onclick="location.href= '/add_employee_form'" class = "btn btn-default btn-lg" id="selectBtn2">새 직원 등록</button>
                </h3>
                                    ...
                                    <c:forEach items="${staffList}" var="row">
                                        <c:if test="${row.resign_flag eq 'N'}">
                                            <tr>
                                                ...
                                                <input type="submit"  class="btn btn-primary btn-block" value="근무표" >
                                                </td>
	                                            </form>
                                            </tr>
                                        </c:if>
