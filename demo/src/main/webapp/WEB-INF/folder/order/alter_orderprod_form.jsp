		...
		<div class="col-md-6">
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-9">
					<input type="button" class="btn btn-primary btn-block" value="변경" onclick="javascript:transfer()"/>
					<input type="button" class="btn btn-primary btn-block" onclick="location.href = '/manage_orderprod?order_no='+${order_no}"
					       value="취소">
				</div>
			</div>
		</div>
...
<script>
    ...
    function transfer(e) {
        ...
        $.ajax({
            type: "POST",
            url: "/alter_orderprod_process?order_no="+${order_no},
            contentType: 'application/json; charset=UTF-8',
            data: JSON.stringify(jsonObj),
            success: function () {
                window.location.href = "/manage_orderprod?order_no="+${order_no};
            },
