            ...
            <div class="logged-user">
                <div class="btn-group">
                    <a href="#" class="btn btn-link dropdown-toggle" data-toggle="dropdown">
                        <img src="resources/img/user-loggedin.png" alt="Sebastian"/><span class="name">Sebastian <i
            ...
            <nav id="main-nav" class="main-nav">
                ...
                <ul class="main-menu">
                    ...
                    <li class="has-submenu">
                        <a href="#" class="submenu-toggle"><i class="icon ion-ios-contact"></i><span
                                class="text">직원 관리</span></a>
                    ...
                    <li><a href="widgets.html"><i class="icon ion-ios-color-wand-outline"></i><span
                            class="text">Widgets</span></a></li>
                    <li class="has-submenu">
                        ...
                        <ul class="list-unstyled sub-menu collapse">
                            ...
                            <li><a href="page-inbox.html"><span class="text">Inbox</span><span class='badge bg-orange'>12</span></a>
                            </li>
                ...
                <ul class="main-menu">
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="list-unstyled sub-menu collapse">
                            <li class="active"><a href="tables-static.html"><span class="text">Static Table</span></a>
                            </li>
