<!DOCTYPE html>
<!--[if IE 9 ]><jsp class="ie ie9" lang="en" class="no-js"> <![endif]-->
<!--[if !(IE)]><!-->
<jsp lang="en" class="no-js">
<!--<![endif]-->
				...
				<nav id="main-nav" class="main-nav">
					...
					<ul class="main-menu">
						<li class="has-submenu active">
							...
							<ul class="list-unstyled sub-menu collapse in">
								<li class="active"><a href="index"><span class="text">Dashboard v1</span></a></li>
								<li><a href="index2"><span class="text">Dashboard v2</span></a></li>
							</ul>
						</li>
						<li class="has-submenu">
							...
							<ul class="list-unstyled sub-menu collapse">
								<li><a href="form-fancy-elements"><span class="text">Fancy Elements</span></a></li>
								<li><a href="form-inplace-editing"><span class="text">In-place Editing</span></a></li>
								<li><a href="form-bootstrap-elements"><span class="text">Bootstrap Elements</span></a></li>
								<li><a href="form-layouts"><span class="text">Form Layouts</span></a></li>
								<li><a href="form-validations"><span class="text">Validation</span></a></li>
								<li><a href="form-upload"><span class="text">File Upload</span></a></li>
								<li><a href="form-text-editor"><span class="text">Text Editor</span></a></li>
								<li><a href="form-wizard"><span class="text">Wizards</span></a></li>
							</ul>
						</li>
						<li class="has-submenu">
							<a href="#" class="submenu-toggle"><i class="icon ion-ios-flask-outline"></i><span class="text">UI Elements</span></a>
							<ul class="list-unstyled sub-menu collapse">
								<li><a href="ui-elements-general"><span class="text">General</span></a></li>
								<li><a href="ui-elements-buttons"><span class="text">Buttons</span></a></li>
								<li><a href="ui-elements-tabs"><span class="text">Tabs</span></a></li>
								<li><a href="ui-elements-tour"><span class="text">Tour</span></a></li>
								<li><a href="ui-elements-icons"><span class="text">Icons</span></a></li>
							</ul>
						</li>
						<li><a href="widgets"><i class="icon ion-ios-color-wand-outline"></i><span class="text">Widgets</span></a></li>
						<li class="has-submenu">
							<a href="#" class="submenu-toggle"><i class="icon ion-ios-copy-outline"></i><span class="text">Pages</span></a>
							<ul class="list-unstyled sub-menu collapse">
								<li><a href="page-projects"><span class="text">Projects</span></a></li>
								<li><a href="page-project-detail"><span class="text">Project Detail</span></a></li>
								<li><a href="page-user-profile"><span class="text">Profile</span></a></li>
								<li><a href="page-search-result"><span class="text">Search Result</span></a></li>
								<li><a href="page-inbox"><span class="text">Inbox</span><span class='badge bg-orange'>12</span></a></li>
								<li><a href="page-view-message"><span class="text">View Message</span></a></li>
								<li><a href="page-new-message"><span class="text">New Message</span></a></li>
								<li><a href="page-knowledgebase"><span class="text">Knowledge Base</span></a></li>
								<li><a href="page-submit-ticket"><span class="text">Submit Ticket</span></a></li>
								<li><a href="page-faq"><span class="text">FAQ</span></a></li>
								<li><a href="page-pricing-tables"><span class="text">Pricing Tables</span></a></li>
								<li><a href="page-invoice"><span class="text">Invoice</span></a></li>
								<li><a href="page-register"><span class="text">Register</span></a></li>
								<li><a href="page-login"><span class="text">Login</span></a></li>
								<li><a href="page-login-alt"><span class="text">Login Alt.</span></a></li>
								<li><a href="page-404"><span class="text">Not Found 404</span></a></li>
								<li><a href="page-505"><span class="text">Error 505</span></a></li>
								<li><a href="page-blank"><span class="text">Blank Page</span></a></li>
							</ul>
						</li>
					</ul>
					<h3>ESSENTIALS</h3>
					<ul class="main-menu">
						<li class="has-submenu">
							...
							<ul class="list-unstyled sub-menu collapse">
								<li class="active"><a href="charts-basic"><span class="text">Basic</span></a></li>
								<li><a href="charts-interactive"><span class="text">Interactive Charts</span></a></li>
							</ul>
						</li>
						<li class="has-submenu">
							<a href="#" class="submenu-toggle"><i class="icon ion-ios-grid-view-outline"></i><span class="text">Tables</span></a>
							<ul class="list-unstyled sub-menu collapse">
								<li class="active"><a href="tables-static"><span class="text">Static Table</span></a></li>
								<li><a href="tables-dynamic"><span class="text">Dynamic Table</span></a></li>
							</ul>
						</li>
						<li><a href="maps"><i class="icon ion-ios-world-outline"></i><span class="text">Maps</span></a></li>
						<li><a href="typography"><i class="icon ion-ios-compose-outline"></i><span class="text">Typography</span></a></li>
						<li class="has-submenu">
