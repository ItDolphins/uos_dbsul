            ...
            <div class="col-md-9">
                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <form class="form-horizontal form-ticket" role="form" action="/add_branch_process"
                              method="post" name='f'>
                            <fieldset>
                                <legend>지점 정보</legend>
                                <div class="form-group">
                                    <label for="store_name" class="col-sm-3 control-label">이름</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="store_pnum" name="store_pnum"
                                               required="required"
                                               placeholder="전화번호">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="store_postno" required="required"
                                               name="store_postno" placeholder="우편번호">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="admin_no" class="col-sm-3 control-label">본사 관리자 번호</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="admin_no" name="admin_no"
                                               required="required"
                                               placeholder="본사 관리자 번호">
                                    </div>
                                </div>
                                <div class="form-group">
