            ...
            <div class="col-md-9">
                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <form class="form-horizontal form-ticket" role="form" action="/add_admin_process"
                              method="post" name='f'>
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="admin_pos" name="admin_pos"
                                               required="required" placeholder="직급">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="admin_pnum" class="col-sm-3 control-label">전화번호</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="admin_pnum" name="admin_pnum"
                                               required="required"
                                               placeholder="전화번호">
                                    </div>
                                </div>
